...
package edu.java.domain.jooq.generation2.tables;

import edu.java.domain.jooq.generation2.DefaultSchema;
import edu.java.domain.jooq.generation2.Keys;
...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, String> LINK_NAME =
        createField(DSL.name("LINK_NAME"), SQLDataType.VARCHAR(1000).nullable(false), this, "");

    /**
     * The column <code>LINK.LAST_CHECK</code>.
     */
    public final TableField<LinkRecord, LocalDateTime> LAST_CHECK =
        createField(DSL.name("LAST_CHECK"), SQLDataType.LOCALDATETIME(6), this, "");

    /**
     * The column <code>LINK.LAST_UPDATE</code>.
     */
    public final TableField<LinkRecord, LocalDateTime> LAST_UPDATE =
        createField(DSL.name("LAST_UPDATE"), SQLDataType.LOCALDATETIME(6), this, "");

    /**
     * The column <code>LINK.LAST_COMMIT</code>.
     */
    public final TableField<LinkRecord, LocalDateTime> LAST_COMMIT =
        createField(DSL.name("LAST_COMMIT"), SQLDataType.LOCALDATETIME(6), this, "");

    /**
     * The column <code>LINK.AMOUNT_ISSUES</code>.
     */
    public final TableField<LinkRecord, Integer> AMOUNT_ISSUES = createField(DSL.name("AMOUNT_ISSUES"),
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function7<? super Long, ? super String, ? super LocalDateTime, ? super LocalDateTime, ? super LocalDateTime, ? super Integer, ? super String, ? extends U> from
    ) {
