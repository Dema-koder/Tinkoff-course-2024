...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, Integer> ANSWER_COUNT = createField(DSL.name("ANSWER_COUNT"), SQLDataType.INTEGER.defaultValue(DSL.field(DSL.raw("-1"), SQLDataType.INTEGER)), this, "");
