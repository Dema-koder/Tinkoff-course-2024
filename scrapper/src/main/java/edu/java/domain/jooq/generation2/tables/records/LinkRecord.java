...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record7<Long, String, LocalDateTime, LocalDateTime, LocalDateTime, Integer, String> {
     ...
     */
    @ConstructorProperties({ "id", "linkName", "lastCheck", "lastUpdate", "lastCommit", "answerCount", "type" })
    public LinkRecord(@Nullable Long id, @NotNull String linkName, @Nullable LocalDateTime lastCheck, @Nullable LocalDateTime lastUpdate, @Nullable LocalDateTime lastCommit, @Nullable Integer answerCount, @Nullable String type) {
        super(Link.LINK);
